...
public class ArrayListResponseTransformer extends AbstractTransformer {
    
    public ArrayListResponseTransformer()   {
        super();
    ...
    public Object doTransform(Object src, String encoding) throws TransformerException   {
    	System.out.println("This is ArrayListResponseTransform transformer, encoding: " + encoding);
    	Map srcMap = (Map)src;
    	...
    	for (String key:keyset){
    		Object payload = srcMap.get(key);  		
    		try {
    			
    			if (payload instanceof ArrayList) {
    				jarr = new JSONArray();
    				jarr.put(payload);
    				converter.put(key, new JSONArray((List)payload));
    			} else {
    				converter.put(key, payload);
    			}//fi */
